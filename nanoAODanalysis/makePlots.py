...
plot(gr_FatJetDeepTag, [], "./Yfigs/figsMjet/BoostedYFraction_FatJet_Deeptag.pdf")
plot(gr_FatJetMatchedDeepTag,[],"./Yfigs/figsMjet/BoostedYFraction_FatJet_DeepTag_matched.pdf")
plot(gr_FatJetUnmatchedDeepTag,[],"./Yfigs/figsMjet/BoostedYFraction_FatJet__DeepTag_unmatched.pdf")
plot(gr_FatJetParticleNet, [], "./Yfigs/figsMjet/BoostedYFraction_FatJet_ParticleNet.pdf")
...
plot(gr_FatJetDeepTag_msd, [], "./Yfigs/figsMsoftdrop/BoostedYFraction_FatJet_DeepTag_msoftdrop.pdf")
plot(gr_FatJetMatchedDeepTag_msd,[],"./Yfigs/figsMsoftdrop/BoostedYFraction_FatJet_DeepTag_matched_msoftdrop.pdf")
plot(gr_FatJetUnmatchedDeepTag_msd,[],"./Yfigs/figsMsoftdrop/BoostedYFraction_FatJet_DeepTag_unmatched_msoftdrop.pdf")
plot(gr_FatJetParticleNet_msd, [], "./Yfigs/figsMsoftdrop/BoostedYFraction_FatJet_Particlenet_msoftdrop.pdf")
plot(gr_FatJetMatchedParticleNet_msd,[],"./Yfigs/figsMsoftdrop/BoostedYFraction_FatJet_ParticleNet_matched_msoftdrop.pdf")
plot(gr_FatJetUnmatchedParticleNet_msd,[],"./Yfigs/figsMsoftdrop/BoostedYFraction_FatJet_ParticleNet_unmatched_msoftdrop.pdf")

plot(gr_msdTOmjetRatioMatched,[],"./Yfigs/figsRatios/msdTOmjetRatioMatched.pdf")
plot(gr_msdTOmjetRatioUnmatched,[],"./Yfigs/figsRatios/msdTOmjetRatioUnmatched.pdf")

plot(gr_DTmjetTOmjetRatioMatched,[],"./Yfigs/figsRatios/DTmjetTOmjetRatioMatched.pdf")
plot(gr_PNmjetTOmjetRatioMatched,[],"./Yfigs/figsRatios/PNmjetTOmjetRatioMatched.pdf")
plot(gr_DTmsdTOmsdRatioMatched,[],"./Yfigs/figsRatios/DTmsdTOmsdRatioMatched.pdf")
plot(gr_PNmsdTOmsdRatioMatched,[],"./Yfigs/figsRatios/PNmsdTOmsdRatioMathced.pdf")

plot(gr_DTmjetTOmjetRatioUnmatched,[],"./Yfigs/figsRatios/DTmjetTOmjetRatioUnmatched.pdf")
plot(gr_PNmjetTOmjetRatioUnmatched,[],"./Yfigs/figsRatios/PNmjetTomjetRatioUnmatched.pdf")
plot(gr_DTmsdTOmsdRatioUnmatched,[],"./Yfigs/figsRatios/DTmsdTOmsdRatioUnmatched.pdf")
plot(gr_PNmsdTOmsdRatioUnmatched,[],"./Yfigs/figsRatios/PNmsdTOmsdRatioUnmatched.pdf")

plot(gr_matchedTOallRatio,[],"./Yfigs/figsRatios/MatchedToAllRatio.pdf")
plot(gr_matchedTOallRatio_msd,[],"./Yfigs/figsRatios/MatchedToAllRatio_msoftdrop.pdf")

plot(gr_matchedTOallRatioDeepTag,[],"./Yfigs/figsRatios/MatchedToAllRatioDeepTag.pdf")
plot(gr_matchedTOallRatioDeepTag_msd,[],"./Yfigs/figsRatios/MatchedToAllRatioDeepTag_msoftdrop.pdf")

plot(gr_matchedTOallRatioParticleNet,[],"./Yfigs/figsRatios/MatchedToAllRatioParticleNet.pdf")
plot(gr_matchedTOallRatioParticleNet_msd,[],"./Yfigs/figsRatios/MatchedToAllRatioParticleNet_msoftdrop.pdf")

for i in range(4):
    plot(boosted_higgs_graphsGenPart[i], [], "./Yfigs/figsMjet/eff/Event_Selection_eff_%i_GenPart.pdf"%i)
    plot(boosted_higgs_graphsFatJet[i], [], "./Yfigs/figsMjet/eff/Event_Selection_eff_%i_FatJet.pdf"%i) 

    plot(boosted_higgs_graphsGenPart_msd[i], [], "./Yfigs/figsMsoftdrop/eff/Event_Selection_eff_%i_GenPart_msoftdrop.pdf"%i)
    plot(boosted_higgs_graphsFatJet_msd[i], [], "./Yfigs/figsMsoftdrop/eff/Event_Selection_eff_%i_FatJet_msoftdrop.pdf"%i)
